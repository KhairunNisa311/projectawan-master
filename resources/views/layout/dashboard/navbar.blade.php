<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="/"><img src="{{asset('dashboard/images/dashboard/baju.jpg')}}" alt="Pixie Furniture" /></a>
        <a class="navbar-brand brand-logo-mini" href="/"><img src="{{asset('dashboard/images/dashboard/baju.jpg')}}" alt="Pixie Furniture" /></a>
    </div>
